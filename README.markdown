...
* Rather, dynamic content is generated by Scala functions that replace/transform placeholder elements in the template. There are two main abstractions:
...
1. Create a template in the `/WEB-INF/templates` directory of your web application, e.g. "hello.html":
...
*	bind/surround/bind-at
	...
	Inserts content inside a template a pre-defined points. Consider the following template (layout.html) that defines a very general page structure:
